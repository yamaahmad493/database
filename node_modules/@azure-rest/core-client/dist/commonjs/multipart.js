...
const isBinaryBody_js_1 = require("./helpers/isBinaryBody.js");
/**
...
function getPartContentType(descriptor) {
    ...
    if ((0, isBinaryBody_js_1.isBinaryBody)(body)) {
...
function normalizeBody(body, contentType) {
    ...
    if (typeof body === "string" || typeof body === "number" || typeof body === "boolean") {
        return (0, core_util_1.stringToUint8Array)(String(body), "utf-8");
    }
    ...
    if (contentType && /application\/(.+\+)?json(;.+)?/i.test(String(contentType))) {
        return (0, core_util_1.stringToUint8Array)(JSON.stringify(body), "utf-8");
    }
    throw new core_rest_pipeline_1.RestError(`Unsupported body/content-type combination: ${body}, ${contentType}`);
}
function buildBodyPart(descriptor) {
    var _a;
    const contentType = getPartContentType(descriptor);
    const contentDisposition = getContentDisposition(descriptor);
    const headers = (0, core_rest_pipeline_1.createHttpHeaders)((_a = descriptor.headers) !== null && _a !== void 0 ? _a : {});
    if (contentType) {
